...
function Sidebar({
  ...
  useEffect(() => {
    const clickHandler = ({ target }: PointerEvent) => {
      if (!sidebar.current || !trigger.current || !(target instanceof Node)) return;
  ...
  return (
    <div className="min-w-fit">
      ...
      <div
        className={`fixed inset-0 bg-gray-900/30 z-40 xl:hidden xl:z-auto transition-opacity duration-200 ${
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex xl:flex! flex-col absolute z-40 left-0 top-0 xl:static xl:left-auto xl:top-auto xl:translate-x-0 h-[100dvh] overflow-y-scroll xl:overflow-y-auto no-scrollbar w-64 xl:w-20 xl:sidebar-expanded:!w-64 shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out ${
      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
              ...
              <span className="xl:hidden xl:sidebar-expanded:block">页面</span>
            </h3>
            <ul className="mt-3">
              <SidebarLinkGroup activecondition={pathname.includes("schoolTest")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              <SidebarLinkGroup activecondition={pathname.includes("schoolExercise")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                          pathname.includes("schoolExercise")
                            ? ""
                            : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
              ...
              <SidebarLinkGroup activecondition={pathname.includes("homeExercise")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                          pathname.includes("homeExercise")
                            ? ""
                            : "hover:text-gray-900 dark:hover:text-white"
                        }`}
                        onClick={(e) => {
        ...
        <div className="pt-3 hidden xl:inline-flex justify-end mt-auto">
