    ...
    <>
      <Menu as="div" className="relative">
        <Menu.Button className="grow flex items-center truncate">
          <img className="w-8 h-8 rounded-full mr-2" src={options[selected].image} width={32} height={32} alt="Group 01" />
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="grow flex items-center truncate">
                        <img className="w-7 h-7 rounded-full mr-2" src={option.image} width={28} height={28} alt="Channel 01" />
