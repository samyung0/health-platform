...
import { mapEntityTypeToChineseFrontend } from "~/lib/utils";
    ...
    <div className="relative inline-flex">
      ...
      >
        ...
        <div className="flex items-center truncate">
          <span className="truncate mx-2 mt-0.5 text-sm font-medium text-gray-600 dark:text-gray-100 group-hover:text-gray-800 dark:group-hover:text-white">
            {session?.allClassifications[0].name}
          </span>
          <svg
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
            ...
            <div className="text-xs text-gray-500 dark:text-gray-400 italic">
              {session?.allClassifications[0].entityType &&
                mapEntityTypeToChineseFrontend(session?.allClassifications[0].entityType)}
            </div>
          </div>
          <ul>
            <li>
