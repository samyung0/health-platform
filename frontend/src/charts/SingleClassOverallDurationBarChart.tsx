...
function SingleClassOverallDurationBarChart({ height }: { height?: number }) {
    ...
    () => ({
      ...
      datasets: dataFetched
        ...
        .map((item, index) => ({
          ...
          hoverBackgroundColor: index === 0 ? defaultColors.sky[600] : defaultColors.red[500],
          pointRadius: 1,
          order: index,
...
export default SingleClassOverallDurationBarChart;
