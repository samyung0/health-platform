...
// Import utilities
import { GRADING_COLORS, GRADING_COLORS_DARK, GRADING_SCALE_KEYS } from "~/lib/const";
import {
  adjustColorOpacity,
  getChartBorderColor,
  getChartColor,
...
function SingleClassDetailGradeBarChart({ height }: { height?: number }) {
  ...
  const data = useMemo<ChartData<"bar">>(
    () => ({
      labels: GRADING_SCALE_KEYS as unknown as string[],
  ...
  return (
    <div className="grow flex flex-col justify-center">
      ...
      <div className="flex items-center justify-center flex-wrap gap-y-1 gap-3 pt-1">
